...
Path*		addelem(Path *, char *, int);
int		addkbdq(Queue*, int);
int		addphysseg(Physseg*);
void		addsummary(char *(*)(char*,char*,void*), void*);
void		addttescape(uint, void(*)(void*), void*);
...
void		pagecpy(Page*, Page*);
void		clearseg(Segment*);
long		cread(Chan*, uchar*, long, vlong);
void		cremove(Chan*);
void		cunmount(Chan*, Chan*);
void		cupdate(Chan*, uchar*, int, vlong);
long		cwrite(Chan*, uchar*, long, vlong);
uintptr		dbgpc(Proc*);
...
char		*dirname(uchar*, int*);
long		dirsetname(char*, int, uchar*, long, long);
void		drawactive(int);
void		drawcmap(void);
void		dumpaproc(Proc*);
void		dumpregs(Ureg*);
...
void		linkseg(Segq*, Segment*);
#define		lock(l)	xlock((l), 0)
void		logopen(Log*);
void		logclose(Log*);
...
void		mmuflush(void);
void		mmuput(Proc*, Page*, uint);
void		mmurelease(Proc*);
void		mmuswitch(void);
Chan*		mntauth(Chan*, char*);
void		mntclose(Mount*);
void		mntdump(Mount*, int);
Chan*		mntlookup(Path*, int, int);
void		mntmount(Mount*, Path*, Chan*, int);
void		mntunmount(Mount*, Path*, Chan*);
...
Chan*		nameop(char*, int, Namec*);
char*		nasummary(char*, char*, void*);
Chan*		newchan(void);
int		newfd(Chan*);
Mount*		newmnt(char*);
Page*		newpage(uint, int, int, uintptr);
Path*		newnpath(Name*);
Path*		newpath(char*);
Rgrp*		newrgrp(void);
Proc*		newproc(void);
...
void		pageinit(void);
void		pagememinit(uintmem, uintmem);
ulong		pagenumber(Page*);
char*		pageseprintsummary(char*, char*);
void		panic(char*, ...);
Cmdbuf*		parsecmd(char *a, int n);
void		pathclose(Path*);
char*		pathlast(Path *p);
ulong		perfticks(void);
void		pexit(char*, int);
void		pgrpcpy(Pgrp*, Pgrp*);
void		pgrpnote(ulong, char*, long, int);
void		prefaultseg(Segment *s);
int		psindex(int);
#define		poperror()		up->nerrlab--
int		postnote(Proc*, int, char*, int);
int		pprint(char*, ...);
int		preempted(void);
int		prefixpath(Path *, Path *);
void		prflush(void);
void		printinit(void);
void		psinit(void);
...
void		relocateseg(Segment*, uintptr, uintptr);
...
Segment*	segvictim(Segq*);
Page**		segwalk(Segment*, uintptr, int);
int		setcolor(ulong, ulong, ulong, ulong);
void		setkernur(Ureg*, Proc*);
int		setlabel(Label*);
void		setregisters(Ureg*, char*, char*, int);
void		setsched(void);
Mount*		setslash(Mount*, Chan*);
...
void		unbreak(Proc*);
Segment*	unlinkseg(Segq*, Segment*);
#define		unlock(l)	xunlock((l), 0)
void		updatedot(void);
void		usedseg(Segq*, Segment*);
void		userinit(void);
uintptr		userpc(Ureg*);
long		userwrite(char*, long);
void*		validaddr(void*, long, int);
void		validname(char*, int);
Name*		validnamedup(char*, int);
void		validstat(uchar*, usize);
void*		vmemchr(void*, int, int);
Proc*		wakeup(Rendez*);
Chan*		walk(Chan*, char**, int);
Chan*		walklater(Chan*, Path*);
Chan*		walked(Chan*);
void		wlock(RWlock*);
void		wunlock(RWlock*);
void		yield(void);
Segment*	data2txt(Segment*);
void		forkseg(Proc*, int, int);
Segment*	newseg(int, uintptr, uintptr, Chan*, uint);
...
uint		nhgetl(void*);
ushort		nhgets(void*);
#define		noschedlock(l)	xlock((l), 1)
#define		noschedunlock(l)	xunlock((l), 1)
int		xlock(Lock*, int);
void		xunlock(Lock*, int);
void		wqfree(Walkqid*);
ulong		µs(void);
